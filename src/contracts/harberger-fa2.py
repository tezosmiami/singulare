...
class Harberger(sp.Contract):
    ...
    def __init__(self, administrator, metadata):
        ...
        self.init_type(sp.TRecord(
            ...
            token_metadata=sp.TBigMap(
                sp.TNat, Harberger.TOKEN_METADATA_VALUE_TYPE),
            # The big map with the tokens operators
            operators=sp.TBigMap(Harberger.OPERATOR_KEY_TYPE, sp.TUnit),
        ...
        contract_metadata = {
            ...
            "source": {
                "tools": ["SmartPy 0.9.1"],
                "location": "https://github.com/teia-community/teia-smart-contracts/blob/main/python/contracts/Harberger.py"
            },
    ...
    def mint(self, params):
        ...
        add_fee_handle = sp.contract(
            t=sp.TRecord(
            token_id=sp.TNat,
            fee_information=Harberger.TOKEN_FEE_TYPE).layout(
    ...
    def update_operators(self, params):
        ...
        sp.set_type(params, sp.TList(sp.TVariant(
            add_operator=Harberger.OPERATOR_KEY_TYPE,
            remove_operator=Harberger.OPERATOR_KEY_TYPE)))
    ...
    def is_operator(self, params):
        ...
        """
        # Define the input parameter data type
        sp.set_type(params, Harberger.OPERATOR_KEY_TYPE)
...
sp.add_compilation_target("Harberger", Harberger(
